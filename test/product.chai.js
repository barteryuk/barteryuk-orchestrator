...
const tesPropicPath =
  "/mnt/c/Users/sandbox/Documents/HACKTIV8/PHASE2R/nagamerah.png";
const tesPropicPath1 =
  "/mnt/c/Users/sandbox/Documents/HACKTIV8/PHASE2R/nagaijo.png";
const testUserCreds = {
...
before(async function () {
  ...
  collateral = await productAPI.addProduct(
    "",
    testInput1,
    { token: testToken1 },
    ""
  ...
  collateral1 = await productAPI.addProduct(
    "",
    testInput,
    { token: testToken1 },
    ""
...
describe("PRODUCTS TESTS", () => {
  ...
  describe("MUTATION - addProduct", () => {
    it("SUCCESSFUL - Server created a product", async () => {
      res = await productAPI.addProduct(
        "",
        testInput,
        { token: testToken },
        ""
  ...
  describe("Query - find OWN PRODUCTS", () => {
    ...
    it("FAILED - Server returns status ? when OWN PRODUCT cannot be found", async () => {
      res = await productAPI.findOwnItems(
        "",
        "",
        { token: `${testToken}01` },
        ""
